<?php $categories = [['Celana' => ['celana','0.1s']], ['Kemeja' => ['kemeja','0.2s']], ['Jaket' => ['jaket','0.3s']], ['Kaos' => ['kaos','0.4s']]];
?>
			...
			<?php foreach ($categories as $category) { ?>
				<?php foreach ($category as $k => $v) { ?>
					<div class="col-lg-3 col-6 gap-3 px-lg-5 px-3 card-kiloan-item">
						<div class="category-kiloan-item wow animate__animated animate__fadeInLeft" data-wow-delay="<?= $v[1] ?>" data-wow-duration="2s">
