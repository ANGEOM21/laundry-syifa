...
$filter = [
	[
		'7 Hari Terakhir' =>
		'admin/kategori/express'
	],
	[
		'1 Bulan Terakhir' =>
		'admin/kategori/express/' . base64_encode(30)
	],
	[
		'6 Bulan Terakhir' =>
		'admin/kategori/express/' . base64_encode(180)
	],
	[
		'1 Tahun Terakhir' =>
		'admin/kategori/express/' . base64_encode(370)
	]
];
?>
...
<div class="content-admin">
	<div class="judul-page">
		<h3>
			<img src="<?= BASEURL; ?>/img/admin/icons/kategori.svg" alt="" style="filter: invert(57%) hue-rotate(180deg) contrast(400%);" width="35"> Kategori Pesanan Express
		</h3>
	</div>
	<div class="container">
		<div class="card px-2 mx-1 border-0 bg-transparent">
			<h3 style="font-weight: 400;"> Kategori Pesanan Express</h3>
			<p>Berikut adalah table kategori pesanan Express</p>
		</div>
