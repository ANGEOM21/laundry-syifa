...
$filter = [
	...
	[
		'1 Bulan Terakhir' =>
		'admin/all-kategori/' . base64_encode(30)
	],
	[
		'6 Bulan Terakhir' =>
		'admin/all-kategori/' . base64_encode(180)
	],
	[
		'1 Tahun Terakhir' =>
		'admin/all-kategori/' . base64_encode(370)
	]
];
?>
...
<div class="content-admin">
	<div class="judul-page">
		<h3>
			<img src="<?= BASEURL; ?>/img/admin/icons/kategori.svg" alt="" style="filter: invert(57%) hue-rotate(180deg) contrast(400%);" width="35"> Kategori Pesanan
		</h3>
	</div>
	<div class="container">
		<div class="card px-2 mx-1 border-0 bg-transparent">
			<h3 style="font-weight: 400;">Semua Kategori Pesanan</h3>
			<p>Berikut adalah table semua kategori pesanan</p>
		</div>
