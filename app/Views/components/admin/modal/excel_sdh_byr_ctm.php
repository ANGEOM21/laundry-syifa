	...
	<div class="modal-dialog modal-lg modal-dialog-scrollable">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">Data Customer Xslsx sudah bayar</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<h3 class="text-center">Data Customer Xslsx Sudah Bayar<img src="<?= BASEURL; ?>/img/icon/excel.png" alt="" width="35"></h3>
						...
						?>
										<tr>
											...
											<td class="col-2 text-center">
												<div class="tipe-pesan">Rp. <?= number_format($row['bayar'], 0, ',', '.') ?></div>
											</td>
