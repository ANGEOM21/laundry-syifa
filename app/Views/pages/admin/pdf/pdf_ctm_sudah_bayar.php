...
<head>
	...
	<title>pdf customer sudah bayar</title>
	<style>
	.container {
		width: 100%;
		padding-right: 15px;
...
<body>
<div class="container">
<h1 style="text-align: center; background-color: #f5f5f5; padding: 10px border-radius: 5px"> Data Customer Sudah Bayar</h1>
...
$html .= "
			<tr>
				<td colspan='5' style='text-align: center; background-color: #4d4d4d; color: white; font-weight: bold'>Total Sudah Bayar Rp " . number_format($total_bayar, 0, ',', '.') . "</td>
			</tr> 
				</tbody>
				</table>
				</div>
...
$date = date('d-m-Y');
$mpdf->WriteHTML($html);
$mpdf->Output('customer-sudah-bayar_'.$date.'.pdf', 'I');
